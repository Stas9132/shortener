...
func (d *Dummy) WithField(key string, value interface{}) *logrus.Entry { return &logrus.Entry{} }
func (d *Dummy) WithFields(fields logrus.Fields) *logrus.Entry         { return &logrus.Entry{} }
